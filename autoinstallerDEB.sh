...
cd
wget https://github.com/tembex83/installer-debian/blob/master/master.zip
...
# install openvpn
https://github.com/tembex83/installer-debian/blob/master/openvpn.sh
...
# downlaod script
cd
wget https://github.com/tembex83/installer-debian/blob/master/create-user.sh
cp /root/create-user.sh /usr/bin/1
chmod +x /usr/bin/1
wget https://github.com/tembex83/installer-debian/blob/master/daftar-user.sh
cp /root/daftar-user.sh /usr/bin/2
chmod +x /usr/bin/2
wget https://github.com/tembex83/installer-debian/blob/master/user-renew.sh
cp /root/user-renew.sh /usr/bin/3
chmod +x /usr/bin/3
wget https://github.com/tembex83/installer-debian/blob/master/hapus.sh
cp /root/hapus.sh /usr/bin/4
chmod +x /usr/bin/4
wget https://github.com/tembex83/installer-debian/blob/master/trial.sh
cp /root/trial.sh /usr/bin/5
chmod +x /usr/bin/5
wget https://github.com/tembex83/installer-debian/blob/master/user-login.sh
cp /root/userlogin.sh /usr/bin/6
chmod +x /usr/bin/6
wget -O speedtest_cli.py "https://raw.githubusercontent.com/sivel/speedtest-cli/master/speedtest.py"
cp /root/speedtest.py /usr/bin/7
chmod +x /usr/bin/7
wget -O bench-network.sh "https://raw.githubusercontent.com/rizal180499/Auto-Installer-VPS/master/conf/bench-network.sh"
cp /root/bench-network.sh /usr/bin/8
chmod +x /usr/bin/8
cp /usr/sbin/reboot /usr/bin/9
chmod +x /usr/bin/9
...
# info
clear
echo "TEMBEX | 085749237043" | tee log-install.txt
...
echo ""  | tee -a log-install.txt
echo "VPS AKAN REBOOT !"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "==============================================="  | tee -a log-install.txt
